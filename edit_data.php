<?php
	...
	if(!isset($_SESSION['id']))
	{
		...
		$query=$db->prepare("SELECT * FROM images WHERE id='$imageId'");
		$query->execute();
...
<div class="container-fluid"> 
	...
	$imageId=$_GET['imageId'];
		...
		mysqli_query($con, "UPDATE images SET imageName='$iname', imageDescription='$iDescription' WHERE id='$imageId'");
